...
console.log(angka === "8"); // false, padahal "8" karena tipe data nya berbeda
console.log(angka === 8); // true

//not strict equals
var angka = 11;
console.log(angka != "11"); // true, padahal "11" adalah string.
console.log(angka !== "11"); // false, padahal "11" karena tipe data nya berbeda
